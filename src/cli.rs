...
async fn add(opts: AddOptions) -> Result<(), Box<dyn Error>> {
...
async fn remove(opts: RemoveOptions) -> Result<(), Box<dyn Error>> {
    let mut client = InventoryClient::connect("http://127.0.0.1:9001").await?;
...
async fn get(opts: GetOptions) -> Result<(), Box<dyn Error>> {
    let mut client = InventoryClient::connect("http://127.0.0.1:9001").await?;
...
async fn update_quantity(opts: UpdateQuantityOptions) -> Result<(), Box<dyn Error>> {
    let mut client = InventoryClient::connect("http://127.0.0.1:9001").await?;
...
async fn update_price(opts: UpdatePriceOptions) -> Result<(), Box<dyn Error>> {
    let mut client = InventoryClient::connect("http://127.0.0.1:9001").await?;
...
async fn watch(opts: GetOptions) -> Result<(), Box<dyn Error>> {
    let mut client = InventoryClient::connect("http://127.0.0.1:9001").await?;
